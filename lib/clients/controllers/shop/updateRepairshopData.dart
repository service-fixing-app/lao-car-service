...
class UpdateRepairshopController extends GetxController {
  ...
  Future<void> updateRepairshopData(UpdateRepairshopData data) async {
    try {
      ...
      var response = await http.put(
        Uri.parse(
            'http://192.168.43.127:5000/api/repairshop/updateRepairshopById/$id'),
        headers: {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        try {
          Get.find<GetRepairshopController>().fetchOneRepairshop();
        } catch (e) {
          // print("Error: $e");
        }
        try {
          Get.find<GetRepairshopController>().fetchRepairshop();
        } catch (e) {
          // print("Error: $e");
        }
      } else {
