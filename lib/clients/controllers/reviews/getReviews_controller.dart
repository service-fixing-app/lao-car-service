...
//   Future<List<CustomerReview>> _attachCustomerDetails(List<CustomerReview> reviews) async {
//     var customers = await fetchCustomers();
//     return reviews.map((review) {
//       var customer = customers.firstWhere((customer) => customer.id == review.customerId);
...
//       } else {
//         print('Failed to retrieve customers. Status code: ${response.statusCode}');
