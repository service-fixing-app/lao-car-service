              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return 'ກະລຸນາປ້ອນຊື່ຮ້ານສ້ອມແປງ';
                      }
                      return null;
                    },
                    inputFormatters: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return 'ກະລຸນາປ້ອນຊື່ແລະນາມສະກຸນເຈົ້າຂອງຮ້ານ';
                      }
                      return null;
                    },
                    inputFormatters: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return 'ກະລຸນາໃສ່ອາຍຸ';
                      }
                      if (int.tryParse(value) == null ||
                          int.parse(value) <= 0) {
                        return 'ກະລຸນາໃສ່ອາຍຸທີ່ຖືກຕ້ອງ';
                      }
                      return null;
                    },
                    inputFormatters: [
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'ກະລຸນາປ້ອນວັນທີ່ເດືອນປີເກີດ';
                            }
                            return null;
                          },
                        ),
                  ...
                  Container(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'ກະລຸນາເລືອກບໍລິການສ້ອມແປງລົດ';
                        }
                        return null;
                      },
                    ),
