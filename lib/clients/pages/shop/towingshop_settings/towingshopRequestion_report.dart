...
import 'package:service_fixing/clients/controllers/report/getRequestTowingController.dart';
import 'package:service_fixing/constants.dart';

class TowingshopRequestReport extends StatefulWidget {
  const TowingshopRequestReport({Key? key}) : super(key: key);

  @override
  State<TowingshopRequestReport> createState() =>
      _TowingshopRequestReportState();
}

class _TowingshopRequestReportState extends State<TowingshopRequestReport> {
  ...
  List<Map<String, dynamic>> getFilteredRows() {
    if (_startDate == null && _endDate == null) {
      return _getRequestTowingshopController.requestRepairData;
    } else {
      return _getRequestTowingshopController.requestRepairData.where((row) {
