...
import 'package:service_fixing/clients/controllers/report/getScoreTowingshopController.dart';
...
class _TowingshopScoreReportState extends State<TowingshopScoreReport> {
  ...
  final GetScoreTowingshopController _getScoreTowingshopController =
  ...
  void initState() {
    ...
    _getScoreTowingshopController.fetchScoreTowingshopData();
    _startDate = null;
    _endDate = null;
  ...
  List<Map<String, dynamic>> getFilteredRows() {
    if (_startDate == null && _endDate == null) {
      return _getScoreTowingshopController.towingScoreData;
    } else {
      return _getScoreTowingshopController.towingScoreData.where((row) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (_getScoreTowingshopController.towingScoreData.isEmpty) {
          return Center(
            child: Column(
